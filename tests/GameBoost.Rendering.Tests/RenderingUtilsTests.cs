...
namespace GameBoost.Rendering.Tests
{
    ...
    public class RenderingUtilsTests
    {
        ...
        {
            var screenPos = new Vector2D(100f, 50f, new MathUtils());
            var cameraPos = new Vector2D(50f, 25f, new MathUtils());
            var result = RenderingUtils.ScreenToWorld(screenPos, cameraPos, 2f, new MathUtils());
        ...
        {
            var worldPos = new Vector2D(25f, 12.5f, new MathUtils());
            var cameraPos = new Vector2D(50f, 25f, new MathUtils());
