...
namespace GameBoost.Rendering.Tests
{
    ...
    public class SpriteBatchTests
    {
        ...
        public void Add_IncreasesCount()
        {
            ...
            batch.Add(new Sprite(new MathUtils(), new Vector2D().Zero(), 1f, 1f));
        ...
        {
            var batch = new SpriteBatch();
            var camera = new Camera2D(new Vector2D().Zero(), 1f, 100f, 100f);
            batch.Add(new Sprite(new MathUtils(), new Vector2D(0f, 0f, new MathUtils()), 10f, 10f)); // In view
            batch.Add(new Sprite(new MathUtils(), new Vector2D(100f, 100f, new MathUtils()), 10f, 10f)); // Out of view
        ...
        {
            var batch = new SpriteBatch();
            batch.Add(new Sprite(new MathUtils(), new Vector2D().Zero(), 2f, 2f));
            batch.Add(new Sprite(new MathUtils(), new Vector2D(1f, 1f, new MathUtils()), 2f, 2f));
            batch.TransformAll(new Vector2D(5f, 0f, new MathUtils()), 90f, 0.5f);
